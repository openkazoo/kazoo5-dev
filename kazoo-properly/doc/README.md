...
See more about building your own at [engineering](./engineering.md).
...
Great opportunites to contribute

* Option to run `seq()` tests in parallel
* Option to collect failed tests rather than die on first failure
* Write JUNIT-style test outputs
