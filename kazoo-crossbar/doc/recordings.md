...
You can change user metadata on a recording to store extra information with the recording for your own purposes. This metadata can also be used by some [storage back-ends](./storage.md#attachments).
