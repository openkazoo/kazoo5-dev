...
-spec fold(kz_term:ne_binary(), payload(), kz_bindings()) -> fold_results().
fold(Routing, Payload, Bindings) ->
    Options = [{'candidates', fun(_) -> Bindings end}
              ],
    kazoo_bindings:fold(Routing, Payload, Options).
