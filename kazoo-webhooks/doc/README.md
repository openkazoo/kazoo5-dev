...
To create a webhook, use either the [Webhooks API](https://docs.2600hz.com/git/2600hz/kazoo-crossbar/doc/webhooks.md) or the [Webhooks UI](https://docs.2600hz.com/frontends/commland/guides/webhooks/).

Webhooks can send data either in query strings (`GET`) or JSON in the request body (`POST`).