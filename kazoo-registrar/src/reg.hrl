...
-type auth_response() :: {'ok', auth_user()} | {'error', any()}.
...
-define(MIGRATE_SOFTPHONE_TO_MS_TEAMS, kapps_config:get_boolean(?CONFIG_CAT, <<"migrate_softphone_to_ms_teams">>, 'false')).
