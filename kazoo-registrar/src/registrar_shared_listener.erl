...
-define(AUTHN_ALT_KEY_PREFIX, <<"authn.endpoint.req">>).
...
-define(BINDINGS, [{'authn', [{'restrict_to', ['authn_routes']}
                             ,{'routes', [{'authn_reg', []}
                                         ,{'authn_req', []}
                                         ,{'authn_reg', [{'routing', ?AUTHN_ALT_KEY_PREFIX}]}
                                         ,{'authn_req', [{'routing', ?AUTHN_ALT_KEY_PREFIX}]}
                                         ]}
                             ]}
